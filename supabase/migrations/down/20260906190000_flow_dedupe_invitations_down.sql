-- Down: 20260906190000_flow_dedupe_invitations.sql
-- Restores get_flow_page's original invitations CTE (no anti-join against
-- ranked), reintroducing review3 finding 18.
