-- Down: 20260906200000_flow_cursor_slot.sql
-- Restores get_flow_page's fixed-v_limit cursor_slot (the finding-18 fix
-- from 20260906190000_flow_dedupe_invitations.sql stays applied),
-- reintroducing review3 finding 31.
